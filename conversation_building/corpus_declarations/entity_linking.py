...
from corpus_declarations.entities import EntityInContext
...
class EntityLinker:
    ...
    def entities_from_text(self, text):
        ...
        return tuple(EntityInContext.from_tapioca_api(text, ent_dict) for ent_dict in result["annotations"])
